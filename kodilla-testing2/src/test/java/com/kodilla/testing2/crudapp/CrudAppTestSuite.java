...
public class CrudAppTestSuite {
  //  private static final BASE_URL ="https://zuzannjanik.github.io";
    ...
    public void initTests() {
        ...
        driver.get("https://zuzannjanik.github.io");
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("zjanik89@gmail.com");
        driverTrello.findElement(By.id("login")).submit();

        Thread.sleep(4000);

        driverTrello.findElement(By.id("password")).sendKeys("Hg:sam4puw4Y(:B");
